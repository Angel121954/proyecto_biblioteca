...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (
        ...
        && !empty($_POST["titulo_libro"]) && !empty($_POST["isbn_libro"])
        && !empty($_POST["categoria_libro"]) && !empty($_POST["disponibilidad_libro"])
        ...
        $sql->efectuarConsulta("INSERT INTO libros(titulo_libro, autor_libro, isbn_libro,
                                categoria_libro, disponibilidad_libro, cantidad_libro)
                                VALUES('$titulo', '$autor', '$isbn', '$categoria', 
